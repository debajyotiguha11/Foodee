...
/**
 *
 * register.php is used to register new restaurants to this app.
 *
 */
...
if (isset($_POST["submit"])) {
    ...
    if (!$error) {
        ...
        $sql = "INSERT INTO restaurants(name, phone, email, password, address) VALUES('$name','$phone','$email','$pass','$address')";
